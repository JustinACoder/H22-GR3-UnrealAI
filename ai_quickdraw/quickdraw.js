const model = tf.loadGraphModel('./jsmodel/model.json');
...
document.getElementById('predict').addEventListener('click', async () => {
    ...
    prediction.innerHTML = '<span style="color: #1c9f00; font-size: large">' + labels[max_index] + '</span>';
});